...
public class historique{
    public static void main(String[] args) {        
        ...
        remplir_historique(liste_coups,joueur1,victoire,testx,testy);
        System.out.println(sortie);
        
    }
    
    static void remplir_historique(ArrayList<String> liste_coups,boolean joueur1,boolean victoire,int testx,int testy){
        int i = 0;
